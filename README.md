...
```scala
//PostgreSQL
libraryDependencies += "dev.zio" %% "zio-sql-postgres" % "0.0.0+1494-5b8c88f6-SNAPSHOT" 

//MySQL
libraryDependencies += "dev.zio" %% "zio-sql-mysql" % "0.0.0+1494-5b8c88f6-SNAPSHOT"

//Oracle
libraryDependencies += "dev.zio" %% "zio-sql-oracle" % "0.0.0+1494-5b8c88f6-SNAPSHOT"

//SQL Server
libraryDependencies += "dev.zio" %% "zio-sql-sqlserver" % "0.0.0+1494-5b8c88f6-SNAPSHOT"
```
