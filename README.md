...
```scala
//PostgreSQL
libraryDependencies += "dev.zio" %% "zio-sql-postgres" % "0.0.0+1483-78f7e70e-SNAPSHOT" 

//MySQL
libraryDependencies += "dev.zio" %% "zio-sql-mysql" % "0.0.0+1483-78f7e70e-SNAPSHOT"

//Oracle
libraryDependencies += "dev.zio" %% "zio-sql-oracle" % "0.0.0+1483-78f7e70e-SNAPSHOT"

//SQL Server
libraryDependencies += "dev.zio" %% "zio-sql-sqlserver" % "0.0.0+1483-78f7e70e-SNAPSHOT"
```
