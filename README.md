...
```scala
//PostgreSQL
libraryDependencies += "dev.zio" %% "zio-sql-postgres" % "0.0.0+1479-59e04c59-SNAPSHOT" 

//MySQL
libraryDependencies += "dev.zio" %% "zio-sql-mysql" % "0.0.0+1479-59e04c59-SNAPSHOT"

//Oracle
libraryDependencies += "dev.zio" %% "zio-sql-oracle" % "0.0.0+1479-59e04c59-SNAPSHOT"

//SQL Server
libraryDependencies += "dev.zio" %% "zio-sql-sqlserver" % "0.0.0+1479-59e04c59-SNAPSHOT"
```
